            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <%--部门提交部门Id即可--%>
                            <select class="form-control" name="dId" id="dept_add_select1">
...
//                alert("用户名可以是2-5中文或者6-16英文和数字组合");
                //显示之前应该清空这个元素之前的样式
                show_validate_msg("#empName_add_input", "error", "用户名可以是2-5中文或者6-16英文和数字组合");
